...
namespace FlatFiles.Scrutinizer.TypeMapping
{
    ...
    public interface IUInt16PropertyMapping
    {
        ...
        /// <returns>The property mapping for further configuration.</returns>
        IUInt16PropertyMapping NullValue(string value);
        ...
        IUInt16PropertyMapping NullHandler(INullHandler handler);
    ...
    internal sealed class UInt16PropertyMapping : IUInt16PropertyMapping, IMemberMapping
    {
        ...
        public UInt16PropertyMapping(UInt16Column column, IMemberAccessor member, int fileIndex, int workIndex)
        {
            this.column = column;
            this.member = member;
        ...
        public IUInt16PropertyMapping NullValue(string value)
        {
            this.column.NullHandler = new ConstantNullHandler(value);
            return this;
        }

        public IUInt16PropertyMapping NullHandler(INullHandler handler)
        {
